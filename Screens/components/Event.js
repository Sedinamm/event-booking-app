...
const Event = ({item}) => {
     ...
     const {Name:nameed,rating:rated, day,month,image:img} = item;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flex:0.5,justifyContent:"center",alignItems:"flex-end",padding:20,borderRadius:10,backgroundColor:"#fff",position:"absolute",width:72,height:75,top:10,right:10}}>
          <Text style={{color:"#000",fontSize:20,alignItems:"center",fontWeight:"bold"}}>{day}</Text>
          <Text style={{color:"#000",fontSize:20, alignItems:"center", fontWeight:"bold",}}>{month}</Text>
      </View>
